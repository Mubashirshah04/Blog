...
export default function CreatePostPage() {
  ...
  // Save selection before opening link popup
  const saveSelection = () => {
  ...
  // Format commands — execCommand for WYSIWYG
  ...
  const savePost = async (saveStatus: "draft" | "published") => {
    ...
    setNotice(`✅ Post "${saveStatus === "published" ? "published" : "saved as draft"}" successfully!`);
    setSaving(false);
  ...
  return (
    <div className={styles.wpWrap}>
      <div className={styles.wpHeader}>
        <h1 className={styles.wpTitle}>Add New Post</h1>
          ...
          <div className={styles.wpMetaBox}>
            ...
            <div className={styles.wpMetaBoxInside}>
              <div className={styles.wpFormGroup}>
                ...
                />
                <p style={{ fontSize: 11, color: '#646970', marginTop: 3 }}>Yeh keyword aapki post ko rank karne mein madad karega</p>
              </div>
              <div className={styles.wpFormGroup}>
          ...
          <div className={styles.wpMetaBox}>
            ...
            <div className={styles.wpMetaBoxInside}>
              <div className={styles.wpPublishActions}>
                <button type="button" className={styles.wpButtonDefault} onClick={() => savePost("draft")} disabled={saving}>
                  {saving ? "Saving..." : "Save Draft"}
                </button>
                <button type="button" className={styles.wpButtonDefault}>Preview</button>
              </div>
              <div className={styles.wpPublishStatus}>
                <div className={styles.wpMiscPubSection}><span className={styles.wpIcon}>📌</span> Status: <strong>Draft</strong></div>
                <div className={styles.wpMiscPubSection}><span className={styles.wpIcon}>👁️</span> Visibility: <strong>Public</strong></div>
                <div className={styles.wpMiscPubSection}><span className={styles.wpIcon}>📅</span> Publish <strong>immediately</strong></div>
              </div>
            </div>
            <div className={styles.wpPublishFooter}>
              <a href="#" className={styles.wpDeleteLink}>Move to Trash</a>
              <button type="button" className={styles.wpButtonPrimary} onClick={() => savePost("published")} disabled={saving}>
